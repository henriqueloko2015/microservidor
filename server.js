...
const DOMINIO = process.env.DOMINIO || "cdn.bb-bet.top"; // Domínio do seu player (para anti-leech)
...
app.listen(port, () => {
    console.log(`Microservidor de streaming rodando em https://cdn.bb-bet.top:${port}`);
